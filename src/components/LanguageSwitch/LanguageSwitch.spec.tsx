...
describe("LanguageSwitch", () => {
    beforeEach(() => {
        ...
        mockUseLanguage.mockReturnValue({
            selectedLanguage: { code: Translation.Languages.en_US.key, name: Translation.Languages.en_US.languageSwitchMenuItemText, abbreviation: "ENG" },
            languages: [
    ...
    it("toggles the menu visibility when the button is clicked", async () => {
        const { container } = render(<LanguageSwitch />);
        const toggleButton = container.querySelector(".toggle");
        const menuContainer = container.querySelector(".language_menu");
