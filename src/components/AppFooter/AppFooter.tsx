      ...
      <div className="footer__container">
        <div className="footer__info">
          ...
          <p className="footer__text">
            <img className="footer__icon-map" src={vectors.footer_map_point} alt="icom_map" /> Made
            in Ukraine
          </p>
        </div>
        <div className="footer__social">
          <a
            ...
            href="https://www.facebook.com/profile.php?id=61566919077712"
            target="_blank"
          ...
          <a
            className="footer__link"
            href="https://www.instagram.com/cheap_it_family/"
            target="_blank"
            rel="noopener noreferrer">
          ...
          <a
            className="footer__link"
            href="https://www.linkedin.com/company/chi-f"
            target="_blank"
            rel="noopener noreferrer">
